...
wget https://github.com/piplabs/story/releases/download/v0.13.0/story-linux-amd64 -O $HOME/story
...
wget -O $HOME/.story/story/config/addrbook.json https://snapshots.nodes.guru/story/addrbook.json
